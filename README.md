...
- User: Ryan.Adams
- IOC IP: 172.16.0.184
- IOC C2 IP: 157.245.46.190 (domain:digitalocean.com, Country: UK, Reported 107 times in AbuseIPDB, Silver C2 tag) 
- Filename: python.exe
- SHA256 Hash:  CFFAB896E9F0B12101034D9CED76332EF5AA4036AFA08E940E825E277C21A044

## Investigation Summary
On 2025-10-25 12:51:44 UTC, a series of authentication attempts targetted several accounts on the workstation `FRONTDESK-PC1`.  
...
Next,  Powershell was executed to create a scheduled task to run `python.exe` at every startup and also execute `python.exe` everytime `Ryan.Adams` opens Powershell.
...
Next, Powershell was executed to run this malicious executable `python.exe` at every system startup and every time `Ryan.Adams` opens Powershell to establish persistance.
...
- Powershell execution: 13:04:59 13:05:06 UTC
